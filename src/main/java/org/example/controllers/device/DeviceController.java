...
public class DeviceController {
    ...
    String devicescount(@PathVariable String serialNumber) throws Throwable {
        if (deviceService.countDeviceOrdersBySerialNumber(serialNumber) > 0) {

            return "This device was ordered "+ (deviceService.countDeviceOrdersBySerialNumber(serialNumber)).toString()+" times";
